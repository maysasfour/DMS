...
INSERT INTO users (email, password, first_name, last_name, phone_number, active) VALUES
  ('admin@dms.com',    '${SEED_ADMIN_HASH}', 'Mays',    'Asfour',    '+962791234567', TRUE),
  ('ops@dms.com',      '${SEED_ADMIN_HASH}', 'Tariq',   'Haddadin',  '+962792345678', TRUE),
  ('lina@example.com', '${SEED_CITIZEN_HASH}','Lina',    'Nassar',    '+962793456789', TRUE),
  ('omar@example.com', '${SEED_CITIZEN_HASH}','Omar',    'Khalil',    '+962794567890', TRUE),
  ('rawan@dms.com',    '${SEED_ADMIN_HASH}', 'Rawan',   'Sweidan',   '+962795678901', TRUE);
...
INSERT INTO admins (name, email, password, phone, role, status) VALUES
  ('System Admin',     'admin@dms.com',    '${SEED_LEGACY_ADMIN_HASH}', '+966501234567', 'SUPER_ADMIN', 'ACTIVE'),
  ('Operations Chief', 'ops@dms.com',      '${SEED_LEGACY_ADMIN_HASH}', '+966502345678', 'ADMIN',       'ACTIVE'),
  ('Alert Manager',    'alerts@dms.com',   '${SEED_LEGACY_ADMIN_HASH}', '+966503456789', 'ALERT_ADMIN', 'ACTIVE');

INSERT INTO citizens (name, email, password, address, gender, blood_type, status) VALUES
  ('Ahmed Al-Rashidi', 'ahmed@example.com',  '${SEED_LEGACY_CITIZEN_HASH}', 'Riyadh, KSA',    'MALE',   'O+', 'ACTIVE'),
  ('Sara Al-Mutairi',  'sara@example.com',   '${SEED_LEGACY_CITIZEN_HASH}', 'Jeddah, KSA',    'FEMALE', 'A+', 'ACTIVE'),
  ('Khalid Hassan',    'khalid@example.com', '${SEED_LEGACY_CITIZEN_HASH}', 'Dammam, KSA',    'MALE',   'B-', 'ACTIVE');
